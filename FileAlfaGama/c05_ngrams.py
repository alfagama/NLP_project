...
with open('Ngrams/bigrams_vaccine_test34.txt', 'w') as file:
...
with open('Ngrams/trigrams_vaccine_test3.txt', 'w') as file:
...
with open('Ngrams/fourgrams_vaccine_test3.txt', 'w') as file:
